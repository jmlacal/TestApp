...
namespace TestApp
{
    public class Matrix2
    {
        ...
        private Matrix2(string[] value)
        {
            this.value = value;
            calculateMaxString();
        }

        public static Matrix2 CreateMatrix(List<string> value)
        {
            Validate(value);
            return new Matrix2(value.ToArray());
        }
        ...
        private static void Validate(List<string> value)
        {
            ...
            foreach (string line in value)
            {
                ...
                {
                    throw new Exception("Error: Todas las lineas de la matriz no tienen la misma longitud");
                }
            }
        }
